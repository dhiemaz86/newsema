...
INSERT INTO `cera_product` (`id_product`, `product_name`, `product_status`, `product_type`, `product_parent_id`, `product_code`, `product_size`, `product_desc`, `product_img`, `product_price`, `created_at`, `updated_at`, `product_pc_id`) VALUES
(1, 'test', NULL, NULL, NULL, NULL, NULL, 'test', NULL, NULL, '2017-08-08 16:15:15', '2017-08-08 16:15:15', NULL);
...
CREATE TABLE `cera_sales` (
  ...
  `sales_quotation_no` varchar(20) DEFAULT NULL,
