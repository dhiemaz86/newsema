        ...
        <section class="content">
          <!-- Info boxes -->
            ...
            <div class="col-xs-12">
             ...
             <a href="adminweb.php?module=tambah_quotation"><button class="btn btn-primary">Tambah Quotation</button></a>
              <a href="adminweb.php?module=print_quotation"><button class="btn btn-primary">Print</button></a>
                  </div><!-- /.box-footer -->
              </div><!-- /.box -->
