        ...
        <section class="content">
          <!-- Info boxes -->
            ...
            <div class="col-xs-12">
              ...
              $queryEdit=mysqli_query($koneksi,"SELECT * FROM cera_product_category WHERE pc_id='$idKategori'");

              $hasilQuery=mysqli_fetch_array($queryEdit);
			       $idKategori=$hasilQuery['pc_id'];
              $namaKategori=$hasilQuery['pc_name'];

              ?>
			        <form class="form-horizontal" action="adminweb.php?module=aksiedit_category" method="post">
